...
async function main() {
  ...
  // const papersContractFactory = await ethers.getContractFactory("Papers");
  // // contructor 있을때 사용
  // const papersContract = await papersContractFactory.deploy();
  // await papersContract.deployed();
  // console.log("Contract Papers deployed to:", papersContract.address);
